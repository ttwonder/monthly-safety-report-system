(function (root) {
  ...
  function statusText(report) {
    return ({ draft: '編輯中', final: '已完成', archived: '封存' })[report.status] || report.status || '草稿';
  }
  ...
  function renderReports() {
    ...
    reports.forEach((report) => {
      ...
      appendTextCell(row, report.systemNumber, 'topic-system-number');
      ...
      appendTextCell(row, Number(report.moduleCount || 0));
